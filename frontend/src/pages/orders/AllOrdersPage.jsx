                        ...
                        >
                            <div className="p-5 flex flex-col gap-2">
                                ...
                                <div className="flex items-center gap-2 mt-3 text-sm text-gray-700">
                                    ...
                                    <span>
                                        {order.loadDetails.type} | {order.loadDetails.weightInKg}kg | Qty: {order.loadDetails.quantity}
                                    </span>
                                </div>
                                ...
                                <div className="flex flex-col text-sm mt-2 text-gray-600">
                                    <span>
                                        <FaTruck className="inline-block text-blue-600 mr-1" />
                                        {order.acceptedTruck?.registrationNumber || 'Not Assigned'}
                                    </span>
                                    <span className="ml-5">
                                        Driver: {order.acceptedDriver?.name || 'Not Assigned'}
                                    </span>
                                    <span className="ml-5">
                                        Transporter: {order.acceptedTransporter?.name || 'Not Assigned'}
                                    </span>
                                </div>
